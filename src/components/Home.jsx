    ...
    return (
      <div className="home">
        ...
        <div className="arhCard">
          <img className="arhImage" src="http://via.placeholder.com/300" alt="Arch of day" />
          <button type="button" id={item.id} onClick={this.pageHandle} className="arhLink">{item.name}</button>
        </div>
      </div>
    );
  }
